...
Agent A2 integrated journey             ✅ SEALED + MERGED
Agent A3 runtime continuity             ✅ SEALED
MCP                                    ⏸ LATER
~~~
...
- [Agent Layer A2 integrated journey](evidence/agent-layer-a2-integrated-journey-certification-2026-09-22.md)
- [Agent Layer A3 durable runtime](evidence/agent-layer-a3-runtime-certification-2026-09-23.md)

## Evidence ledger

| Gate | Source SHA | Run | Job | Artifact | SHA-256 | Receipt |
|---|---|---:|---:|---:|---|---|
| Agent A3 durable runtime | 9e22f3a58c06a24627302f03856adfe4c62c36df | 35867288650 | agent-a3-seal | mk1-agent-a3-seal-35867288650 | f1eadf01c5349f32b8f263006d6c75561c33e921fe6841e6d00c60413b225837 | [receipt](evidence/agent-layer-a3-runtime-certification-2026-09-23.md) |
| Agent A2 integrated journey | `9438e5eb85fab866d437effe7063b18afdff500e` | `35807358759` | `agent-a2-seal` | `mk1-agent-a2-seal-35807358759` | `c5724e5ab08002a40cc9620929ba8aa95502550da59d69a8fe5cc33e96c62e0d` | [receipt](evidence/agent-layer-a2-integrated-journey-certification-2026-09-22.md) |
...
Agent A1       ✅ SEALED + MERGED
Agent A2       ✅ SEALED + MERGED
Agent A3       ✅ SEALED
First trial    ⏭ MANUAL AGENT JOURNEY
MCP            ⏸ LATER
~~~

A3 preserves A0–A2 authority boundaries and is sealed. The next step is the first manual Agent journey.
